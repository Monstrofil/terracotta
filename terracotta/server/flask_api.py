...
def create_app(debug: bool = False, profile: bool = False) -> Flask:
    ...
    import terracotta.server.colourful
    ...
    with new_app.test_request_context():
        ...
        SPEC.path(view=terracotta.server.colourful.get_colourful)
        SPEC.path(view=terracotta.server.colourful.get_colourful_preview)
